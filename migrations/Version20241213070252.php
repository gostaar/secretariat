 ...
 */
final class Version20241213070252 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE documents_utilisateur (id INT AUTO_INCREMENT NOT NULL, type_document_id INT DEFAULT NULL, dossier_id INT DEFAULT NULL, service_id INT DEFAULT NULL, client_id INT DEFAULT NULL, date_document DATETIME NOT NULL, expediteur VARCHAR(255) NOT NULL, destinataire VARCHAR(255) NOT NULL, file_path VARCHAR(255) NOT NULL, is_active TINYINT(1) NOT NULL, details VARCHAR(255) NOT NULL, INDEX IDX_C78002328826AFA6 (type_document_id), INDEX IDX_C7800232611C0C56 (dossier_id), INDEX IDX_C7800232ED5CA9E6 (service_id), INDEX IDX_C780023219EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE events (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, location VARCHAR(255) DEFAULT NULL, start DATETIME NOT NULL, end DATETIME NOT NULL, google_calendar_event_id JSON DEFAULT NULL, INDEX IDX_5387574A19EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE facture (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, montant NUMERIC(10, 2) NOT NULL, date_paiement DATETIME NOT NULL, date_facture DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', status VARCHAR(255) NOT NULL, commentaire LONGTEXT DEFAULT NULL, is_active TINYINT(1) NOT NULL, INDEX IDX_FE86641019EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
